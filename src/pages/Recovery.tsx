...
import { AlertTriangle, Phone, MessageSquare, Clock, TrendingDown } from 'lucide-react';
                    ...
                    return (
                      <div key={clientId} className="p-4 rounded-lg border bg-card hover:shadow-md transition-shadow">
                        ...
                        <div className="text-sm text-muted-foreground mb-3">
                          {data.schedules.length} échéance{data.schedules.length > 1 ? 's' : ''} en retard • 
                          Plus ancien: {formatDate(oldestSchedule.due_date)} ({daysOverdue} jours)
                        </div>
