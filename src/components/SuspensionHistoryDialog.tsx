...
import { Loader2, Ban, CheckCircle, Clock } from 'lucide-react';
      ...
      <DialogContent className="max-w-2xl max-h-[80vh]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Historique des suspensions - {userName}
          </DialogTitle>
        </DialogHeader>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Suspendu par <span className="font-medium text-foreground">{suspension.suspended_by_name}</span>
                        </p>
                      </div>
                    ...
                    {suspension.lifted_at && (
                      <div className="pt-2 border-t">
                        <p className="text-sm text-success">
                          Levée le {formatDateTime(suspension.lifted_at)}
                          {suspension.lifted_by_name && (
                            <> par <span className="font-medium">{suspension.lifted_by_name}</span></>
                          )}
                        </p>
                      </div>
                    )}
