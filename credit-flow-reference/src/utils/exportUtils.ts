 ...
 */
export function exportToPDF(data: any[], headers: string[], filename: string, title: string = 'Rapport') {
  const doc = new jsPDF()
 ...
 */
export async function exportToXLSX(data: any[], headers: string[], filename: string, sheetName: string = 'Données') {
  // Créer le workbook
