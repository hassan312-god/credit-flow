...
import { Ban, CheckCircle, Loader2, Lock, Mail, ShieldAlert } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between">
        ...
        <div className="space-y-6">
          <h2 className="font-display text-4xl font-bold text-primary-foreground leading-tight">
            Gérez vos prêts avec
            {' '}
            <span className="text-accent">simplicité</span>
            {' '}
            et
            {' '}
            <span className="text-accent">efficacité</span>
          </h2>
              ...
              <div className="mb-4 p-4 rounded-lg bg-destructive/10 border border-destructive/20">
                ...
                {suspensionInfo.reason && (
                  <p className="text-sm text-muted-foreground">
                    Raison :
                    {' '}
                    <span className="text-foreground">{suspensionInfo.reason}</span>
                  </p>
                )}
              </div>
            )}
